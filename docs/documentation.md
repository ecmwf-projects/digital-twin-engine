...
|                      |                  MultIO                  |                                    Plume |
|:---------------------|:----------------------------------------:|-----------------------------------------:|
| Whole field view     | <span style="color:green">&check;</span> |   <span style="color:red">&cross;</span> |
| Asynchronous         | <span style="color:green">&check;</span> |   <span style="color:red">&cross;</span> |
| Manages I/O          | <span style="color:green">&check;</span> |   <span style="color:red">&cross;</span> |
| Supports plugins     | <span style="color:green">&check;</span> | <span style="color:green">&check;</span> |
| Data at every T-step |  <span style="color:red">&cross;</span>  | <span style="color:green">&check;</span> |
| Reads any Atlas type |  <span style="color:red">&cross;</span>  | <span style="color:green">&check;</span> |
| Reads built-in types |  <span style="color:red">&cross;</span>  | <span style="color:green">&check;</span> |
